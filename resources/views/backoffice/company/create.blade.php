        ...
        <form action="{{ route('admin.company.store') }}" method="POST">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="text" class="form-control" id="ice" name="ice" value="{{ old('ice') }}">
              <span class="text-danger">
                @error('ice')
                    {{ $message }}
                @enderror
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="phone_number" name="phone_number" placeholder="06XXXXXXXX" value="{{ old('phone_number') }}">
            <span class="text-danger">
              @error('phone_number')
                  {{ $message }}
              @enderror
